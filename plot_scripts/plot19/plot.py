...
def append_plot(ax,filename,col):
    data = numpy.loadtxt( datadir+'/'+filename)
    ax.plot( data[:,0],data[:,col],label=filename)
...
def plot1(h0,h):
    ...
    fig = pp.figure()
    ax  = fig.add_subplot(111)
    append_plot(ax, "data005.dat",3)
    append_plot(ax, "data01.dat",3)
    append_plot(ax, "data02.dat",3)
    ax.set_title("sigma")

    fig = pp.figure()
    ax  = fig.add_subplot(111)
    append_plot(ax, "data005.dat",1)
    append_plot(ax, "data01.dat",1)
    append_plot(ax, "data02.dat",1)
